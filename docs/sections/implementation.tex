...
\begin{enumerate}
    ...
    \shellcmd{"c:\\Program Files\\Unity\\Hub\\Editor\\2019.2.17f1\\Editor\\Unity.exe" \-batchmode \-nographics \-executeMethod BuildScript.PerformBuild \-quit \-projectPath game \-logFile \-}
